...
const MyOrders = () => {
    ...
    return (
        <>
            <MetaData title="My Orders | Fashion Fusion Hub" />
            ...
            <main className="w-full mt-16 sm:mt-0">
                ...
                <div className="flex gap-3.5 mt-2 sm:mt-6 sm:mx-3 m-auto mb-7">
                    ...
                    <div className="hidden sm:flex flex-col w-1/5 px-1">
                        ...
                        {/* <!-- nav tiles --> */}
                        <div className="flex flex-col bg-gray-300 rounded-sm shadow">

                            {/* <!-- filters header --> */}
                            <div className="flex items-center justify-between gap-5 px-4 py-2 border-b">
                                <p className="text-lg font-medium">Filters</p>
                                <span onClick={clearFilters} className="text-gray-600 font-medium text-sm uppercase cursor-pointer hover:text-gray-800">clear all</span>
                            </div>
                    ...
                    <div className="flex-1">
                        ...
                        {loading ? <Loader /> : (
                            <div className="flex flex-col gap-3 sm:mr-4 overflow-hidden">
                                ...
                                {/* <!-- searchbar --> */}
                                <form onSubmit={searchOrders} className="flex items-center justify-between mx-1 sm:mx-0 sm:w-10/12 bg-gray-300 border rounded hover:shadow">
                                    ...
                                    <button type="submit" className="h-full text-sm px-1 sm:px-4 py-2.5 text-white bg-gray-600 hover:bg-gray-800 rounded-r flex items-center gap-1">
                                ...
                                {orders && filteredOrders.length === 0 && (
                                    <div className="flex items-center flex-col gap-2 p-8 bg-gray-300">
                                        <img draggable="false" src="" alt="Empty Orders" />
