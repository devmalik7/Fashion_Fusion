...
const OrderDetails = () => {
    ...
    return (
        <>
            <MetaData title="Order Details | Fashion Fusion Hub" />
                    ...
                    <>
                        {order && order.user && order.shippingInfo && (
                            <div className="flex flex-col gap-4 max-w-6xl mx-auto">
                                ...
                                <div className="flex bg-gray-300 shadow rounded-sm min-w-full">
                                ...
                                {order.orderItems && order.orderItems.map((item) => {
                                    ...
                                    return (
                                        <div className="flex flex-col sm:flex-row min-w-full shadow rounded-sm bg-gray-300 px-2 py-5" key={_id}>
