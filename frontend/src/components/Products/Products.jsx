...
const Products = () => {
    ...
    return (
        <>
            <MetaData title="All Products | Fashion Fusion Hub" />
                ...
                <div className="flex gap-3 mt-2 sm:mt-2 sm:mx-3 m-auto mb-7">
                    ...
                    <div className="hidden sm:flex flex-col w-1/5 px-1">
                        ...
                        <div className="flex flex-col bg-gray-300 rounded-sm shadow">
                            ...
                            <div className="flex items-center justify-between gap-5 px-4 py-2 border-b">
                                ...
                                <span className="uppercase text-gray-600 text-xs cursor-pointer font-medium" onClick={() => clearFilters()}>clear all</span>
                            </div>
                    ...
                    <div className="flex-1">
                        ...
                        {!loading && products?.length === 0 && (
                            <div className="flex flex-col items-center justify-center gap-3 bg-gray-300 shadow-sm rounded-sm p-6 sm:p-16">
                        ...
                        {loading ? <Loader /> : (
                            <div className="flex flex-col gap-2 pb-4 justify-center items-center w-full overflow-hidden bg-gray-300">
