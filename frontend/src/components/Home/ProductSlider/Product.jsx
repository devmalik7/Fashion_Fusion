...
const Product = (props) => {
    ...
    return (
        <div className="flex flex-col items-center gap-2 ml-4  py-4 relative shadow-md">
            {/* <!-- image & product title --> */}
            <Link to={`/product/${_id}`} className="flex flex-col items-center text-center group">
                ...
                <h2 className="text-sm mt-4 group-hover:text-primary-gray-600">{name.length > 50 ? `${name.substring(0, 50)}...` : name}</h2>
            </Link>
            {/* <!-- image & product title --> */}
            ...
            <div className="flex flex-col gap-2 items-center">
                ...
                <div className="flex items-center gap-1.5 text-md font-medium">
                    ...
                    <span className="text-xs text-gray-600 ">{getDiscount(price, cuttedPrice)}%&nbsp;off</span>
                </div>
                {/* <!-- price container --> */}
            </div>
            {/* <!-- product description --> */}
