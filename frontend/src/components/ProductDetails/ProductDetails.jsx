        ...
        <>
            {loading ? <Loader /> : (
                <>
                    ...
                    <main className=" mt-36 sm:mt-0">
                   

                        {/* <!-- product image & description container --> */}
                        <div className="w-full flex flex-col sm:flex-row bg-gray-300 sm:p-2 relative">
                            ...
                            <div className="w-full sm:w-2/5 sm:sticky top-16 sm:h-screen">
                                ...
                                <div className="flex flex-col gap-3 m-3">
                                    ...
                                    <div className="w-full flex gap-3">
                                        {/* <!-- add to cart btn --> */}
                                        {product.stock > 0 && (
                                            <button onClick={itemInCart ? goToCart : addToCartHandler} className="p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-gray-600 rounded-sm shadow hover:shadow-lg">
                                                <ShoppingCartIcon />
                                                {itemInCart ? "GO TO CART" : "ADD TO CART"}
                                            </button>
                                        )}
                                        <button onClick={buyNow} disabled={product.stock < 1 ? true : false} className={product.stock < 1 ? "p-4 w-full flex items-center justify-center gap-2 text-white bg-pink-600 cursor-not-allowed rounded-sm shadow hover:shadow-lg" : "p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-pink-600 rounded-sm shadow hover:shadow-lg"}>
                                            <FlashOnIcon />
                            ...
                            <div className="flex-1 py-2 px-3">
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    <span className="text-sm text-gray-500 font-medium flex gap-2 items-center">
                                        <span className="text-xs px-1.5 py-0.5 bg-gray-600 rounded-sm text-white flex items-center gap-0.5">{product.ratings && product.ratings.toFixed(1)} <StarIcon sx={{ fontSize: "12px" }} /></span>
                                        <span>{product.numOfReviews} Reviews</span>
                                    </span>
                                    {/* <!-- rating badge --> */}

                                    {/* <!-- price desc --> */}
                                    {/* <span className="text-gray-100 text-sm font-medium">Special Price</span> */}
                                    ...
                                    {product.stock <= 10 && product.stock > 0 && (
                                        <span className=" text-pink-400 text-sm font-medium">Hurry, Only {product.stock} left!</span>
                                    )}
                                    {/* <!-- price desc --> */}
                                    ...
                                    <div className="flex gap-16 mt-4 items-center text-sm font-medium">
                                        ...
                                        <Link className="font-medium text-pink-400  ml-3" to="/">{product.brand && product.brand.name}</Link>
                                    </div>
                                    {/* <!-- seller details --> */}
                                    ...
                                    <div className="w-full mt-4 rounded-sm border flex flex-col">
                                        <div className="flex justify-between items-center border-b px-6 py-4">
                                            ...
                                            <button onClick={handleDialogClose} className="shadow bg-gray-600  text-white px-4 py-2 rounded-sm hover:shadow-lg">Rate Product</button>
                                        </div>
