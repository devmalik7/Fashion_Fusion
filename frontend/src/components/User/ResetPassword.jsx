...
const ResetPassword = () => {
  ...
  return (
    <>
      <MetaData title="Password Reset | Fashion Fusion Hub" />

      {loading && <BackdropLoader />}
      <main class="w-full mt-12 sm:pt-20 sm:mt-0">

        {/* <!-- row --> */}
        <div class="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-gray-300 shadow-lg">
          ...
          <div class="flex-1 overflow-hidden">
            ...
            <div class="text-center py-10 px-4 sm:px-14">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div class="flex flex-col w-full gap-4">
                  ...
                  <div class="flex flex-col gap-2.5 mt-2 mb-32">
                    ...
                    <button type="submit" class="text-white py-3 w-full bg-gray-600 shadow hover:shadow-lg rounded-sm font-medium">Submit</button>
                  </div>
                  {/* <!-- button container --> */}
              ...
              <Link to="/register" class="font-medium text-sm text-gray-500">New to Fashion Fusion Hub? Create an account</Link>
            </div>
            {/* <!-- edit info container --> */}
