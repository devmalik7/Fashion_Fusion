...
const Register = () => {
    ...
    return (
        <>
            <MetaData title="Register | Fashion Fusion Hub" />
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                <button type="submit" className="text-white py-3 w-full bg-gray-600 shadow hover:shadow-lg rounded-sm font-medium">Signup</button>
                                <Link to="/login" className="hover:bg-gray-50 text-pink-400 text-center py-3 w-full shadow border rounded-sm font-medium">Existing User? Log in</Link>
                            </div>
