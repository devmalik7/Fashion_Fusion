                ...
                <>
                    ...
                    <main className="w-full mt-12 sm:mt-0">
                        ...
                        <div className="flex gap-3.5 sm:w-11/12 sm:mt-4 m-auto mb-7">
                            ...
                            {/* <!-- details column --> */}
                            <div className="flex-1 overflow-hidden shadow bg-gray-300">
                                {/* <!-- edit info container --> */}
                                <div className="flex flex-col gap-12 m-4 sm:mx-8 sm:my-6">
                                    {/* <!-- personal info --> */}
                                    <div className="flex flex-col gap-5 items-start">
                                        <span className="font-medium text-lg">Personal Information <Link to="/account/update" className="text-sm text-pink-400 font-medium ml-8 cursor-pointer">Edit</Link></span>

                                        <div className="flex flex-col sm:flex-row items-center gap-3" id="personalInputs">
                                            <div className="flex flex-col gap-0.5 w-64 px-3 py-1.5 rounded-sm border inputs cursor-not-allowed bg-gray-100 focus-within:border-pink-400">
                                    ...
                                    <div className="flex flex-col gap-5 items-start">
                                        <span className="font-medium text-lg">Email Address
                                            <Link to="/account/update" className="text-sm text-pink-400 font-medium ml-3 sm:ml-8 cursor-pointer">Edit</Link>
                                            <Link to="/password/update" className="text-sm text-pink-400 font-medium ml-3 sm:ml-8">Change Password</Link>
                                        </span>
                                    ...
                                    <div className="flex flex-col gap-5 items-start">
                                        <span className="font-medium text-lg">Mobile Number
                                            <span className="text-sm text-pink-400 font-medium ml-3 sm:ml-8 cursor-pointer" id="mobEditBtn">Edit</span>
                                        </span>
                                    ...
                                    {/* <div className="flex flex-col gap-4 mt-4">
                                        ...
                                        <h4 className="text-sm font-medium">When will my Fashion Fusion Hub account be updated with the new email address (or mobile number)?</h4>
                                        ...
                                        <h4 className="text-sm font-medium">What happens to my existing Fashion Fusion Hub account when I update my email address (or mobile number)?</h4>
                                        ...
                                        <p className="text-sm">Fashion Fusion Hub has a 'single sign-on' policy. Any changes will reflect in your Seller account also.</p>

                                    </div> */}
                                    {/* <!-- faqs --> */}

                                    {/* <!-- deactivate account --> */}
                                    <Link className="text-sm text-pink-400 font-medium" to="/">Deactivate Account</Link>
                                    {/* <!-- deactivate account --> */}
                                </div>
                                {/* <!-- edit info container --> */}
