...
const Sidebar = ({ activeTab }) => {
    ...
    return (
        <div className="hidden sm:flex flex-col bg-gray-300 gap-4 w-1/4 px-1">

            {/* <!-- profile card --> */}
            <div className="flex items-center gap-4 p-3 bg-gray-300 rounded-sm shadow">
                {/* <!-- user icon --> */}
            ...
            <div className="flex flex-col bg-gray-300 rounded-sm shadow">
                ...
                <div className="flex items-center gap-5 px-4 py-4 border-b">
                    <span className="text-gray-600"><FolderIcon /></span>
                ...
                {/* <div className="flex items-center gap-5 px-4 py-4">
                    <span className="tex"><PersonIcon /></span>
                ...
                {/* <!-- logout tab --> */}
                <div className="flex items-center gap-5 px-4 py-4 border-b">
                    <span className="text-gray-600"><PowerSettingsNewIcon /></span>
                    <div className="flex w-full justify-between font-medium text-gray-500 hover:text-gray-600 cursor-pointer" onClick={handleLogout}>
                        Logout
                        <span><ChevronRightIcon /></span>
                    </div>
                </div>
            ...
            <div className="flex flex-col items-start gap-2 p-4 bg-gray-300 rounded-sm shadow">
