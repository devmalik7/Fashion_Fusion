...
const footerLinks = [
  {
    ...
    links: [
      ...
      {
        name: "Fashion Fusion Hub Stories",
        redirect: "/",
      },
      {
        name: "Press",
      ...
      {
        name: "Fashion Fusion Hub Wholesale",
        redirect: "/",
      },
      {
...
const Footer = () => {
  ...
  return (
    <>
      {!adminRoute && (
        <>
          <footer className="mt-20 w-full py-1 sm:py-4 px-4 sm:px-12 bg-gray-600  text-white text-xs border-b border-gray-600 flex flex-col sm:flex-row overflow-hidden">
            ...
            <div className="w-full sm:w-5/12 my-6 mx-5 sm:mx-0 flex flex-col sm:flex-row gap-2 sm:gap-0 justify-between">
              <div className="w-full sm:w-1/2">
                ...
                <p className="mt-2 leading-5">Fashion Fusion Hub Internet Private Limited,<br />
          ...
          {/* <div className="px-16 py-6 w-full bg-primary-darkBlue hidden sm:flex justify-between items-center text-sm text-white">
            <a href="https://seller.flipkart.com/sell-online" target="_blank" rel="noreferrer" className="flex items-center gap-2">
              <span className="text-yellow-400"><WorkIcon sx={{ fontSize: "20px" }} /></span> Sell On Fashion Fusion Hub
            </a>
            ...
            <span>&copy; 2007-{new Date().getFullYear()} FashionFusionHub.com</span>
