...
const Shipping = () => {
    ...
    return (
        <>
            <MetaData title="Fashion Fusion Hub: Shipping Details" />
                        ...
                        <Stepper activeStep={1}>
                            <div className="w-full bg-gray-300">
                                ...
                                <form onSubmit={shippingSubmit} autoComplete="off" className="flex flex-col justify-start gap-3 w-full sm:w-3/4 mx-1 sm:mx-8 my-4">
                                    ...
                                    <button type="submit" className=" bg-gray-600 w-full sm:w-1/3 my-2 py-3.5 text-sm font-medium text-white shadow hover:shadow-lg rounded-sm uppercase outline-none">save address</button>
                                </form>
                            </div>
                        </Stepper>
                    </div>
